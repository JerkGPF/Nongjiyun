...
public class Knowledge_Menu_Pro_WheatActivity extends AppCompatActivity {
    ...
    private void initFirst() {
        ...
        Knowledge_Menu_Pro_Wheat_Main h1 = new Knowledge_Menu_Pro_Wheat_Main(R.mipmap.pro_head, "张洪程", "江苏现代农业（水稻）产业技术体系集成创新中心", "首席专家", "集成创新", Knowledge_Menu_Animal_Pig_DetailActivity.class);
    ...
    private void initSecond() {
        ...
        Knowledge_Menu_Pro_Wheat_Normal h1 = new Knowledge_Menu_Pro_Wheat_Normal(R.mipmap.pro_head, "周宏", "江苏现代农业（水稻）产业技术体系产业经济研究团队", "岗位专家", "旱杂粮", null);
        Knowledge_Menu_Pro_Wheat_Normal h2 = new Knowledge_Menu_Pro_Wheat_Normal(R.mipmap.pro_head, "杨洪建", "江苏现代农业（水稻）产业技术体系产业经济研究团队", "岗位专家", "豆类", null);
        Knowledge_Menu_Pro_Wheat_Normal h3 = new Knowledge_Menu_Pro_Wheat_Normal(R.mipmap.pro_head, "徐晓杰", "江苏现代农业（水稻）产业技术体系产业经济研究团队", "岗位专家", "集成创新", null);
        Knowledge_Menu_Pro_Wheat_Normal h4 = new Knowledge_Menu_Pro_Wheat_Normal(R.mipmap.pro_head, "谢成林", "江苏现代农业（水稻）产业技术体系产业经济研究团队", "岗位专家", "花生", null);
        Knowledge_Menu_Pro_Wheat_Normal h5 = new Knowledge_Menu_Pro_Wheat_Normal(R.mipmap.pro_head, "李刚华", "江苏现代农业（水稻）产业技术体系产业经济研究团队", "岗位专家", "集成创新", null);
        Knowledge_Menu_Pro_Wheat_Normal h6 = new Knowledge_Menu_Pro_Wheat_Normal(R.mipmap.pro_head, "周宏", "江苏现代农业（水稻）产业技术体系产业经济研究团队", "岗位专家", "集成创新", null);
    ...
    private void initThird() {
        ...
        Knowledge_Menu_Pro_Wheat_Dir h1 = new Knowledge_Menu_Pro_Wheat_Dir(R.mipmap.pro_head, "周宏", "江苏现代农业（水稻）产业技术体系产业经济研究团队", "基地主任", "集成创新", null);
        Knowledge_Menu_Pro_Wheat_Dir h2 = new Knowledge_Menu_Pro_Wheat_Dir(R.mipmap.pro_head, "杨洪建", "江苏现代农业（水稻）产业技术体系产业经济研究团队", "基地主任", "花生", null);
        Knowledge_Menu_Pro_Wheat_Dir h3 = new Knowledge_Menu_Pro_Wheat_Dir(R.mipmap.pro_head, "徐晓杰", "江苏现代农业（水稻）产业技术体系产业经济研究团队", "基地主任", "中药材", null);
        Knowledge_Menu_Pro_Wheat_Dir h4 = new Knowledge_Menu_Pro_Wheat_Dir(R.mipmap.pro_head, "谢成林", "江苏现代农业（水稻）产业技术体系产业经济研究团队", "基地主任", "集成创新", null);
        Knowledge_Menu_Pro_Wheat_Dir h5 = new Knowledge_Menu_Pro_Wheat_Dir(R.mipmap.pro_head, "李刚华", "江苏现代农业（水稻）产业技术体系产业经济研究团队", "基地主任", "玉米", null);
        Knowledge_Menu_Pro_Wheat_Dir h6 = new Knowledge_Menu_Pro_Wheat_Dir(R.mipmap.pro_head, "周宏", "江苏现代农业（水稻）产业技术体系产业经济研究团队", "基地主任", "集成创新", null);
